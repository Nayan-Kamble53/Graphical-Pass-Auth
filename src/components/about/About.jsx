...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col bg-richblack-900 pb-[9vh]">
      <div className="bg-richblack-900 w-full">
        <div className="bg-richblack-700 h-[65vh] w-full flex flex-col items-center pt-[5%]">
          ...
          <div className="gifs flex gap-10">
            <img width={400} src={gif1} alt="Graphical authentication demo 1" />
            <img className="gif1" width={400} src={gif1} alt="Graphical authentication demo 2" />
            <img width={400} src={gif1} alt="Graphical authentication demo 3" />
          </div>
        </div>
        ...
        <div className="flex justify-evenly items-center">
          ...
          <div className="gifs mt-5">
            <img width={450} src={gif2} alt="Graphical authentication feature demo" />
          </div>
        </div>

        <div className="flex justify-evenly mt-10 mb-10">
          <div className="max-w-[55vw] text-lg">
