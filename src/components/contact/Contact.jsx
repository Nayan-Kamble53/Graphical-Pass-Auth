  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://graphical-pass-auth.onrender.com/contact`,
        formData
      );
      ...
      setTimeout(() => {
        toast.info(
          "Thank You for reaching out to us, we will get in touch with you shortly!",
          {
            autoClose: 4000
          }
        );
        ...
        <div className="con1 flex flex-col gap-y-4 my-16 shadow-richblack-200 shadow-lg p-12 rounded-3xl">
          ...
          <div className="conInp flex gap-3">
            <label className="text-lg text-richblack-5 leading-[1.375rem] ">
              ...
              <br />
              <input
                className="mt-2 bg-richblack-800 rounded-[0.75rem] text-[15px] w-[15vw] p-[12px] text-richblack-5"
                type="text"
                name="firstName"
            ...
            <label className="text-lg text-richblack-5 leading-[1.375rem] mx-3">
              ...
              <br />
              <input
                className="mt-2 bg-richblack-800 text-[15px] rounded-[0.75rem] w-[15vw] p-[12px] text-richblack-5"
                type="text"
                name="lastName"
          ...
          <div className="inp">
            <label className="text-lg text-richblack-5 leading-[1.375rem]">
              ...
              <br />
              <input
                className="mt-2 bg-richblack-800 text-[15px] rounded-[0.75rem] w-[31.5vw] p-[12px] text-richblack-5"
                type="email"
                name="email"
          ...
          <div>
            <button
              className="bg-yellow-50 w-full py-[8px] px-[2rem] rounded-[8px] font-medium text-richblack-900"
              type="submit"
